...
const CTAGuarantee = ({
  ...
  return <div className={`flex flex-col items-center gap-2 ${className}`}>
      {showBadge && <img src="/lovable-uploads/36484096-74f6-40bb-988c-86af5ddd059a.png" alt="30 Days Money Back Guarantee" className="w-20 h-20 sm:w-24 sm:h-24 object-contain" />}
