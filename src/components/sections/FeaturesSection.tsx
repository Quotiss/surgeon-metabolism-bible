            ...
            <CardContent className="p-0">
              <div className="prose prose-lg max-w-none text-slate-700 leading-relaxed">
                <p className="text-base sm:text-lg md:text-xl">
                  <span className="font-semibold text-blue-600">Dr. Mark T.</span>, a 44-year-old orthopedic surgeon, was hitting the wall every afternoon. <span className="italic">"I'd crush my morning surgeries, then by 2 PM I felt like I was moving through mud,"</span> he says. His wife noticed he'd stopped joining their weekend bike rides - he was just too drained.
                </p>
                
                <p className="text-base sm:text-lg md:text-xl mt-4">
                  When Mark learned his erratic schedule was creating metabolic chaos, he made a few simple adjustments to work with his stress patterns instead of against them. Within two weeks, that afternoon crash disappeared.
                </p>
                
                <p className="text-base sm:text-lg md:text-xl mt-4">
                  <span className="italic">"I actually had energy left for my family again. My wife joked that I got my old self back."</span> The best part? It required almost no extra time - just doing things differently.
                </p>
              </div>
            </CardContent>
          </Card>
